                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-butons">
                            ...
                            <div class="wrap-btn">
                                ...
                                <a href="#" wire:click.prevent="removeFromWishlist({{$product->id}})"  class="btn  fill-heart "><i class="fa fa-heart fill-heart"></i>Added Wishlist</a>
                                @else
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{$pp->price}}</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}'>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{route('product.details',['slug'=>$rp->slug])}}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{route('product.details',['slug'=>$rp->slug])}}" class="product-name"><span>{{$rp->name}}</span></a>
                                    <div class="wrap-price"><span class="product-price">{{$rp->price}}</span></div>
                                </div>
                            </div>
