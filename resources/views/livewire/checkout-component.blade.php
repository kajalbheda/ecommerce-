							...
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									...
									<p class="row-in-form">
										...
										<input ry type="text" name="country" value="" placeholder="United States" wire:model="country">
						...
						<div class="col-md-12">
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									...
									<p class="row-in-form">
										<label for="country">Country<span>*</span></label>
										<input ry type="text" name="country" value="" placeholder="United States">
									</p>
									<p class="row-in-form">
										<label for="zip-code">Postcode / ZIP:</label>
						...
						<div class="summary-item payment-method">
							...
							<div class="choose-payment-methods">
								<label class="payment-method">
									...
									<span class="payment-desc">Order Now! Pay on Delivety</span>
								</label>
								<label class="payment-method">
